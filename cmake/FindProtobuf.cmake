...
function(PROTOBUF_GENERATE_CPP SRCS HDRS DEST)
    ...
    foreach (FIL ${ARGN})
        ...
        list(APPEND ${SRCS} "${DEST}/${PROTO_PATH}/${FIL_WE}.pb.cc")
        list(APPEND ${HDRS} "${DEST}/${PROTO_PATH}/${FIL_WE}.pb.h")

        add_custom_command(
                OUTPUT "${DEST}/${PROTO_PATH}/${FIL_WE}.pb.cc"
                "${DEST}/${PROTO_PATH}/${FIL_WE}.pb.h"
                COMMAND protobuf::protoc
                ARGS --cpp_out ${DEST}/${PROTO_PATH} ${_protobuf_include_path} ${ABS_FIL}
...
find_library(PROTOBUF_LIBRARY NAMES protobuf PATHS ${GRPC_LIB_PATH})
...
find_library(PROTOBUF_LITE_LIBRARY NAMES protobuf-lite PATHS ${GRPC_LIB_PATH})
...
find_library(PROTOBUF_PROTOC_LIBRARY NAMES protoc PATHS ${GRPC_LIB_PATH})
...
find_program(PROTOBUF_PROTOC_EXECUTABLE NAMES protoc PATHS ${GRPC_BIN_PATH} NO_DEFAULT_PATH)
